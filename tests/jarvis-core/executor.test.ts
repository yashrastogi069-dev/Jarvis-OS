    ...
    const capabilities: CapabilityDefinition[] = [
      {
        ...
        handler: async (input) => searchHandler(input),
      ...
      },
      {
        ...
        handler: async (input) => createHandler(input),
      ...
      },
      {
        ...
        handler: async (input) => deleteHandler(input),
      ...
      },
      {
        ...
        handler: async (input) => notifyHandler(input),
